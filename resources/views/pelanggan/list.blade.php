                    ...
                    <tr>
                        ...
                        <td>
                            @if ($item->foto_pelanggan)
                                <img src="{{ $item->foto_pelanggan }}" alt="Foto Pelanggan" width="100"
                                    class="img-thumbnail"
                                    onerror="this.outerHTML='<div style=\'width:100px;height:100px;background:#d1d5db;display:flex;align-items:center;justify-content:center;\'>Pelanggan</div>'">
                            @else
                                <div
